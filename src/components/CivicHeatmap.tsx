...
const CivicHeatmap: React.FC = () => {
  ...
  useEffect(() => {
    axios.get(DELHI_GEOJSON_URL)
      ...
      .catch(() => setError("Could not load Delhi boundaries."));
  }, []);
  ...
  return (
    <div className="position-relative w-100" style={{ minHeight: 500, borderRadius: "1.25rem", overflow: "hidden", border: '1px solid #dee2e6', boxShadow: '0 1px 8px #ccc' }}>
      {loading && (
