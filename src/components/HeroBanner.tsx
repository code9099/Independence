...
export default function HeroBanner() {
  ...
  return (
    <section aria-label="Hero" className="relative hero-gradient rounded-2xl overflow-hidden shadow-xl">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 md:px-12 py-14 md:py-20 text-center text-primary-foreground">
        <h1 className="text-5xl md:text-7xl font-extrabold leading-tight tracking-tight animate-in fade-in slide-in-from-top-2">
          Make Your City Better
          <span className="block text-gradient">Report. Track. Resolve.</span>
        </h1>
        <p className="mt-4 text-base md:text-lg text-primary-foreground/90 max-w-2xl mx-auto animate-in fade-in delay-100">
          A professional civic platform with an engaging, modern, cinematic feel.
        </p>
        <div className="mt-8 flex items-center justify-center gap-3 animate-in fade-in delay-200">
